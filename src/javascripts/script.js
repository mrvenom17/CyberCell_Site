    ...
    .then(data=>{
        ...
        upcoming_events.forEach(event => {
            ...
            <div class="event h-[550px] w-fit flex flex-col items-center justify-evenly p-8 ">
                    ...
                    <a class="px-6 py-3 bg-white text-black rounded-full text-lg border-2 hover:bg-black hover:text-white hover:border-white duration-500" href="/cybercell.html">Know more</a>
